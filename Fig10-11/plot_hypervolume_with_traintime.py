...
"""
folders = ['./H-RBFleX_Large_trans101_positive/Results',
           './MultiOpt_Large_noband_trans101/Results',
           #'./MultiOpt_Large_Acc_noband_trans101/Results',
           './MultiOpt_Large_Acc_noband_trans101/Results_random_sss',
           './H-WOT_Large_noband_trans101/Results']  # Replace with actual folder paths

"""
folders = ['./NSGA_Acc_noband/Results',
           "./MultiOpt_Large_Acc_noband/Results_randomsearch",
           "./MultiOpt_Large_Acc_noband/Results",
           "./MultiOpt_Large_noband/Result",
           './H-WOT_Large_noband/Results',
           "./H-RBFleX_Large_noband/Results_init100"
           ]
...
plt.ylim(1.48E+7, 1.52E+7) # (b) RBFleX vs NASWOT
plt.xlim(0, 45) # (b) RBFleX vs NASWOT
...
# Display the plot
plt.savefig("[plot_hypervolume_with_traintime]ex_imageclass_v5b.pdf", format="pdf")
plt.show()