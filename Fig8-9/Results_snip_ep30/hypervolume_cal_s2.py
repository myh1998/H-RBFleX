...
#ref_point = np.array([100, 1e7])  #Version 1 Adjust based on your data
ref_point = np.array([15, 1e7])  #Version 2 Adjust based on your data
...
results_df.to_csv("cumulative_hypervolume_s2_v2.csv", index=False)
